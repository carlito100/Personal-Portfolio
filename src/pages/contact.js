    ...
    <div className="w-full min-h-screen flex flex-col justify-center relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-8">
          ...
          <form className="space-y-6 bg-white/[0.02] p-8 border border-white/5 relative overflow-hidden">
            ...
            <button className="w-full group relative py-4 bg-[#697565] text-white font-mono text-xs uppercase tracking-[0.3em] overflow-hidden transition-all hover:bg-[#5a6556]">
