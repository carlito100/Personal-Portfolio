...
const ProjectItem = ({ project, index }) => {
  ...
  return (
    <div 
      ref={ref}
      className={`group relative bg-[#1E201E] p-8 lg:p-12 transition-all duration-1000 ease-[cubic-bezier(0.2,0.8,0.2,1)] hover:bg-[#1a1c1a] flex flex-col justify-between ${
        isVisible 
